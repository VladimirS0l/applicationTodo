package ru.java.usersservice.keycloak;
...
public class KeycloakUtils {
    ...
    public void addRoles(String userId, List<String> roles) {
        ...
        UserResource uniqueUsersResource = usersResource.get(userId);
        uniqueUsersResource.roles().realmLevel().add(kcRoles);
    }
    ...
    public void updateKeyCloak(UserDto user) {
        CredentialRepresentation credentialRepresentation = createPasswordCredentials(user.getPassword());
